    ...
    <DashboardLayout>
      ...
      <div className='space-y-6'>
        ...
        <form
          ...
          className='space-y-6'
        >
          <AppCard title='Details' description='Name and descriptions. Slug is generated automatically from the name.'>
          ...
          <AppCard title='Price' description='Set the price for this addon on the same page.'>
            <div className='grid gap-4 md:grid-cols-2'>
              <FormField label='Billing type' htmlFor='billingType' required error={errors.billingType}>
                <Select
          ...
          <div className='flex gap-2'>
            <Button type='submit' disabled={processing} isLoading={processing} loadingText='Creating…'>
              Create addon
            </Button>
